...
export const EVENT_ITEMS_FETCH_AND_SET = 'EVENT_ITEMS_FETCH_AND_SET';
export const EVENT_ITEMS_UPDATE = 'EVENT_ITEMS_UPDATE';
export const EVENT_ITEMS_APPEND = 'EVENT_ITEMS_APPEND';
export const EVENT_ITEMS_DELETE = 'EVENT_ITEMS_DELETE';

export const TRACK_ITEMS_FETCH_AND_SET = 'TRACK_ITEMS_FETCH_AND_SET';
export const TRACK_ITEMS_UPDATE = 'TRACK_ITEMS_UPDATE';
export const TRACK_ITEMS_APPEND = 'TRACK_ITEMS_APPEND';
export const TRACK_ITEMS_DELETE = 'TRACK_ITEMS_DELETE';

export const PARTICIPANT_ITEMS_FETCH_AND_SET =
  'PARTICIPANT_ITEMS_FETCH_AND_SET';
export const PARTICIPANT_ITEMS_UPDATE = 'PARTICIPANT_ITEMS_UPDATE';
export const PARTICIPANT_ITEMS_APPEND = 'PARTICIPANT_ITEMS_APPEND';
export const PARTICIPANT_ITEMS_DELETE = 'PARTICIPANT_ITEMS_DELETE';

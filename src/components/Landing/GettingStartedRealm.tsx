    ...
    <div className="getting-started">
      <div>
        ...
        <div className="getting-started--steps realm-top-2">
          ...
          <div className="typography-7">Set Transit URL in your product</div>
          <div className="typography-4">
            To provide seemless experience to your users, add a link from your
            product to Transit. By triggering a button for example from your
            product, your users will be securely transferred to Transit with
            their details.
          </div>
          <div className="typography-7">
            Securely transmit user information to Transit
          </div>
          <div className="typography-4">
